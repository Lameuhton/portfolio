        ...
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          <div>
            ...
            <button className="px-1 py-1 w-full sm:w-fit rounded-full bg-transparent bg-gradient-to-br from-blue-500 via-primary-500 to-secondary-500 hover:bg-slate-800 text-white mt-3">
              <a href="/CV-aureliane-gagliardi.pdf" download>
                <span className="block bg-[#121212] hover:bg-gradient-to-br from-blue-500 via-primary-500 to-secondary-500 rounded-full px-5 py-2">
                  Télécharger mon CV
                </span>
              </a>
            </button>
